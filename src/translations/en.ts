export const en = {
  ...
  staging_commit: "to commit the files you just staged to your local repository run",
  push_title: "push",
  push_to_remote: "to push your code to the remote repository you need to run",
  push_to_remote_desc: "this assumes that you're pushing to the master branch",
  git_push: "the next time you push your code you only need to run",
  u_note_1: "the",
  u_note_2: "tag sets the default branch to whatever you choose",
  push_different_branch: "if you want to push your code to a different branch you can do",
  ...
  branch_create: "to create a branch simply run",
